...
thumbnailImage: /images/Mills.jpg
...
<p>
  ...
  <img border="0" alt="John Mills" src="/images/Mills.jpg" width="150" height="150" align="left">
  </a>
</p>

<!-- CV -->
<p align="center">
  <a href="https://docs.google.com/document/d/e/2PACX-1vTjHNqn69rjIXIvfEE95WWpr_zD3DRDr00Q2GYD4xArfk45ZoZ4SqZgPQAGECNAUJ-w5kY1PDHRohIq/pub" class="fa fa-file fa-2x" style="color:#00B969;">
  </a>
</p>

<!-- TWITTER -->
<p align="center">
  <a href="https://twitter.com/DrJPMills" class="fa fa-twitter fa-2x">
  </a>
</p>
 
<!-- ORCID -->
<p align="center">
  <a href="https://orcid.org/0000-0002-8813-4438" class="ai ai-orcid fa-2x" style="color:#000000;">
  </a>
</p>
...
member_name <- "John Mills"
special_skill <- c("registered reports", "ethics")

OS_skills <- read_csv(here("static/OS_skills.csv")) %>%
  dplyr::filter(name %in% c("max", "min", member_name)) %>%
  dplyr::select(c("reproducible analysis", "open source software", "data sharing", "data management", "preregistration", all_of(special_skill), "open access"))
