...
An invitation on _Outlook_ calendar has been sent to researchers in the ReproducibiliTea mailing list (if you want to be included, contact _schettino@eur.nl_). Please explicitly **Accept** or **Decline** the invitation, so that catering and room capacity can be evaluated accordingly.

## Next Meeting

The next meeting will take place on **March 11th 2020** at **11:00** in room **room G2-35** ([G building](https://www.eur.nl/en/campus/locations/spaces/g-building)). Contact _schettino@eur.nl_ to be the next disussant!
