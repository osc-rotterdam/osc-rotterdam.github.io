...
* if you want to learn how to use Git but using RStudio is the only reason why you will no join this webinar, please notify Antonio (*schettino@eur.nl*). We are considering having a similar webinar where we use a Git GUI (e.g., [GitHub Desktop](https://desktop.github.com/) or [GitKraken](https://www.gitkraken.com/git-client)) instead of RStudio;
